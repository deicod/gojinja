...
| Expressions | Async/await expressions (`await`, async filters/tests) unsupported | Resolved | Parser and evaluator support await expressions and auto-await async helpers |
